          ...
          <ContentFadeIn>
            <div className="text-center mb-16">
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Want me to build for you? I'll love to work with unique and
                creative ideas and move your bussiness at a upgraded scale.
              </p>
            </div>
          </ContentFadeIn>
              ...
              <div className="flex flex-col h-full">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <a
                          href="https://wa.me/+8801303342438"
                          className="text-gray-600 hover:text-gray-900 transition-colors duration-200"
                        >
                          +8801303342438
                        </a>
                ...
                <div className="bg-gray-100 rounded-xl p-8 mt-auto">
                  ...
                  <p className="text-gray-600 mb-4">
                    Let's move your bussiness upscale with my team!
                  </p>
